...
// PremiumListings ABI
export const PREMIUM_LISTINGS_ABI = [
  // View functions
  { name: 'totalRevenue', type: 'function', stateMutability: 'view', inputs: [], outputs: [{ type: 'uint256' }] },
  { name: 'isPremium', type: 'function', stateMutability: 'view', inputs: [{ name: '_projectId', type: 'uint256' }], outputs: [{ type: 'bool' }] },
  {
    name: 'getPremiumListing',
    type: 'function',
    stateMutability: 'view',
    inputs: [{ name: '_projectId', type: 'uint256' }],
    outputs: [{
  ...
  { name: 'getActivePremiumCount', type: 'function', stateMutability: 'view', inputs: [], outputs: [{ type: 'uint256' }] },
  // Write functions
  { name: 'purchaseWithEth', type: 'function', stateMutability: 'payable', inputs: [{ name: '_projectId', type: 'uint256' }, { name: '_tier', type: 'uint8' }], outputs: [] },
  // Events
  { name: 'PremiumPurchased', type: 'event', inputs: [{ name: 'projectId', type: 'uint256', indexed: true }, { name: 'tier', type: 'uint8', indexed: false }, { name: 'amount', type: 'uint256', indexed: false }, { name: 'endTime', type: 'uint256', indexed: false }] },
] as const;

// CuratorNFT ABI (ERC1155 + custom)
export const CURATOR_NFT_ABI = [
  // Constants
  { name: 'EARLY_CURATOR_STANDARD', type: 'function', stateMutability: 'view', inputs: [], outputs: [{ type: 'uint256' }] },
  { name: 'EARLY_CURATOR_LEGENDARY', type: 'function', stateMutability: 'view', inputs: [], outputs: [{ type: 'uint256' }] },
  { name: 'SCAM_HUNTER_STANDARD', type: 'function', stateMutability: 'view', inputs: [], outputs: [{ type: 'uint256' }] },
  { name: 'SCAM_HUNTER_LEGENDARY', type: 'function', stateMutability: 'view', inputs: [], outputs: [{ type: 'uint256' }] },
  { name: 'TOP_VALIDATOR_STANDARD', type: 'function', stateMutability: 'view', inputs: [], outputs: [{ type: 'uint256' }] },
  { name: 'TOP_VALIDATOR_LEGENDARY', type: 'function', stateMutability: 'view', inputs: [], outputs: [{ type: 'uint256' }] },
  // ERC1155 standard
  ...
  { name: 'uri', type: 'function', stateMutability: 'view', inputs: [{ name: 'tokenId', type: 'uint256' }], outputs: [{ type: 'string' }] },
  // Custom view functions
  {
    ...
    inputs: [{ name: 'user', type: 'address' }],
    outputs: [
      { name: 'hasEarlyCuratorStd', type: 'bool' },
      { name: 'hasEarlyCuratorLeg', type: 'bool' },
      { name: 'hasScamHunterStd', type: 'bool' },
      { name: 'hasScamHunterLeg', type: 'bool' },
      { name: 'hasTopValidatorStd', type: 'bool' },
      { name: 'hasTopValidatorLeg', type: 'bool' },
    ]
  },
  { name: 'getVoteWeightMultiplier', type: 'function', stateMutability: 'view', inputs: [{ name: 'user', type: 'address' }], outputs: [{ type: 'uint256' }] },
  { name: 'getRewardMultiplier', type: 'function', stateMutability: 'view', inputs: [{ name: 'user', type: 'address' }], outputs: [{ type: 'uint256' }] },
  {
    name: 'getAllPrices',
    type: 'function',
    stateMutability: 'view',
    inputs: [],
    outputs: [
      { name: 'earlyCuratorPrice', type: 'uint256' },
      { name: 'scamHunterPrice', type: 'uint256' },
      { name: 'topValidatorPrice', type: 'uint256' },
    ]
  },
  {
    name: 'getSupplyInfo',
  ...
  { name: 'hasMinted', type: 'function', stateMutability: 'view', inputs: [{ name: '', type: 'address' }, { name: '', type: 'uint256' }], outputs: [{ type: 'bool' }] },
  // Write functions
  { name: 'mintLegendary', type: 'function', stateMutability: 'nonpayable', inputs: [{ name: 'tokenId', type: 'uint256' }], outputs: [] },
  // Events
  { name: 'NFTMinted', type: 'event', inputs: [{ name: 'user', type: 'address', indexed: true }, { name: 'tokenId', type: 'uint256', indexed: true }, { name: 'isLegendary', type: 'bool', indexed: false }] },
  { name: 'NFTUpgraded', type: 'event', inputs: [{ name: 'user', type: 'address', indexed: true }, { name: 'fromTokenId', type: 'uint256', indexed: false }, { name: 'toTokenId', type: 'uint256', indexed: false }] },
] as const;
